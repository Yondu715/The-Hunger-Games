...
javac --module-path .\Libs\javafx\lib --add-modules=javafx.controls,javafx.fxml,mysql.connector.java --class-path "..;.;" .\game\client\*.java
javac --module-path .\Libs\javafx\lib --add-modules=javafx.controls,javafx.fxml,mysql.connector.java --class-path "..;.;" .\game\*.java
